...
# ---------------------------
# Main Interface Tabs: Results, Logs, and Summary
# ---------------------------
...
with tabs[0]:
    ...
    if st.session_state.results:
        # Create a tab for each processed PDF (each PDF represents a company)
        ...
        for idx, pdf in enumerate(pdf_names):
            with pdf_tabs[idx]:
                ...
                for theme, quotes in st.session_state.results[pdf].items():
                    ...
                    approved = []
                    # Display each long quote with a checkbox immediately to its left
                    for quote in quotes:
