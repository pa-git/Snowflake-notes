...
def load_contract_from_json(data: dict):
    ...
    print("Creating or retrieving parties...")
    parties = {}
    ...
    print("Adding service level agreements...")
    ...
    print("Adding roles, resources and rates...")
    for r in data.get("roles", []):
        ...
        if not res:
            print(f"  - New Resource: {r['resource_name']}")
